...
class Generator(nn.Module):
    def __init__(self, noise_dim, num_classes=10):
        ...
        self.pipe = nn.Sequential(
            # 4*4*256
            deconv_block(in_channels=noise_dim * 2, out_channels=256, kernel_size=(4, 4),
            ...
            # 32*32*32
            deconv_block(in_channels=64, out_channels=32, kernel_size=(4, 4), stride=(2, 2), padding=(1, 1)),

            # 64*64
            nn.ConvTranspose2d(in_channels=32, out_channels=1, kernel_size=(4, 4),
